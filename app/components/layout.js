  ...
  return (
    <div>
      ...
      <div className={styles.container}>
        ...
        <footer>
        <p><a href="https://forms.gle/cNgRuEyUQWDPr4rr8" target="_blank" rel="external noopener noreferrer">Ανάφερε κάποιο μεμονωμένο περιστατικό</a> για να το αναρτήσουμε,
          {' '}<a href="mailto:balourdos@protonmail.com">επικοινώνησε μαζί μας</a>{' '}
            ή, αν γράφεις κώδικα, <a href="https://github.com/balourdos/MemonomenaPeristatika.gr" target="_blank" rel="external noopener noreferrer">βοήθησέ μας με την
